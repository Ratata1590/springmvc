...
public class DynamicCodeUtil {
  ...
  public static final List<String> UTILNAME_LIST = Arrays.asList(new String[] {"clearDynObj",
      "getDynObj", "newDynObj", "getClass", "getBean", "newObj", "getStaticProp", "setStaticProp",
      "callStaticMethod", "getObjProp", "setObjProp", "callObjMethod"});
  ...
  public static Object callStaticMethod(Object theClass, String methodName, Object... param)
    ...
    return ((Class<?>) theClass).getMethod(methodName, revolseObjectParamType(param)).invoke(null,
        param);
  }
