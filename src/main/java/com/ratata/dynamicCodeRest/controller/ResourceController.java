...
public class ResourceController {
  ...
  public static ConcurrentHashMap<String, byte[]> resources =
  ...
  public static void uploadResource(@RequestParam("file") MultipartFile[] file,
  ...
  public static void deleteResources(@RequestBody(required = true) List<String> fileList)
      throws Exception {
  ...
  private static JsonNode listFileToJson(TreeMap<String, String> resourcesList, String basePath,
      Boolean showGoto) {
  ...
  public static void uploadZipFrontEnd(@RequestParam("file") MultipartFile[] file)
      throws Exception {
  ...
  public static void downloadZipFrontEnd(HttpServletRequest request, HttpServletResponse response)
      throws Exception {
    String key = getResourcePathFromRequest(request);
  ...
  private static void zipFiles(List<String> fileList, HttpServletResponse response)
      throws Exception {
