...
public class DynamicCodeRestEndpointController {
  ...
  public Object callClassMethod(@RequestHeader(required = true) String methodName,
    ...
    return classList.get(className)
        .getMethod(methodName, DynamicCodeUtil.revolseObjectParamType(param)).invoke(null, param);
  }
  ...
  public Object callObjMethod(@RequestHeader(required = true) String instanceId,
    ...
    return obj.getClass().getMethod(methodName, DynamicCodeUtil.revolseObjectParamType(param))
        .invoke(obj, param);
  }
