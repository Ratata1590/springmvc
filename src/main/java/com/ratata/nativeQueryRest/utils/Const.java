...
public interface Const {
  ...
  public static final String DELETEOBJECT_ID = "id";
  public static final String DELETEOBJECT_CLASSNAME = "className";
  public static final String DELETEOBJECT_STATUS = "status";
  public static final String DELETEOBJECT_SUCCESS = "success";
